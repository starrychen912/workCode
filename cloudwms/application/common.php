...
if (!function_exists('uploadproduct')) {
    /**
     * 产品导入到amazon
     * @ApiParams (name="file", type="integer", required=true, description="xml内容")
     * @ApiParams (name="feedType", type="integer", required=true, description="feedType")
     *
     */
    function uploadproduct($file,$feedType){
        // initData();
        $options = [
