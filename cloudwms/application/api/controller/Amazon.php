...
// var_dump($body);die;
    ...
    // var_dump($key);die;
            $file = file_get_contents($_SERVER['DOCUMENT_ROOT']."/template/amazon/productprice.xml");
    ...
    public function createFeed(){
        ...
        $body = '{
            ...
            "inputFeedDocumentId":"amzn1.tortuga.3.d4b3e5a5-6ef7-4a2d-9cf7-b66dd947cba3.TOZ16FXG7S4AD"
          }';
    ...
    public function getFeedDocument(){
        ...
        // $feed_document_id = "amzn1.tortuga.3.b56502a5-423a-4eac-8261-64fcc8551f85.TY3DS2VBZXBQW";
        $feed_document_id = "amzn1.tortuga.3.256a6592-423c-40ae-b671-c21c030089e6.T1LSPJ4M1CLE4K";
...
// var_dump($feed_processing_report_content);die;
    ...
    public function getAuthorizationCode(){
        ...
        $apiInstance = new \ClouSale\AmazonSellingPartnerAPI\Api\AuthorizationApi(
            // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
            // This is optional, `GuzzleHttp\Client` will be used as default.
            // new \GuzzleHttp\Client(),
            $this->config
        );
        $selling_partner_id  = "A1W97C6EDFE8I4";
        $developer_id  = "912373548221";
        $mws_auth_token  = "amzn1.application-oa2-client.78af05242c684864b592accb082bc4a8";
    ...
    public function CreateInboundShipmentPlan(){
        ...
        try {
            ...
            $result1 = $result->getPayload()->getInboundShipmentPlans()[0]->getShipmentId();
            $result2 = $result->getPayload()->getInboundShipmentPlans()[0]->getDestinationFulfillmentCenterId();
            print_r($result);print_r($result1);print_r($result2);
        } catch (Exception $e) {
    ...
    public function updateInboundShipment(){
        ...
        // $body = '{"contentType":"text/xml; charset=UTF-8"}';
        $body->setInboundShipmentHeader([
            'ShipmentName'  =>  'FBA STA (03/04/2022 12:02)-FTW2',
            'ShipFromAddress'  =>  [
                'Name'  =>  'Gorilla Store',
                'AddressLine1'  =>  '9637 Pierront STt2',
                'AddressLine2'  =>  'BURKE',
                'DistrictOrCounty'  =>  'US',
                'City'  =>  'Richmond',
                'StateOrProvinceCode'  =>  'VA',
        ...
        $body->setInboundShipmentItems([[
            'SellerSKU'  =>  'YZB-SHYP-CWL-009-01',
            'FulfillmentNetworkSKU'  =>  'X0036FDYOL',
            'QuantityShipped'  =>  '1'
        ]]);
        $body->setMarketplaceId('ATVPDKIKX0DER');
        $shipment_id = 'FBA16M0YN1QR';
        // var_dump($body);die;
        try {
    ...
    public function getLabels(){
        ...
        $shipment_id = "FBA16LZZXYMZ"; // string | A shipment identifier originally returned by the createInboundShipmentPlan operation.
        ...
        $label_type = "WORKING"; // string | The type of labels requested.
        $number_of_packages = 1; // int | The number of packages in the shipment.
        ...
        $number_of_pallets = 1; // int | The number of pallets in the shipment. This returns four identical labels for each pallet.
        $page_size = 1;
    ...
    public function getInboundGuidance(){
        ...
        $marketplace_id = 'ATVPDKIKX0DER';
        try {
            $result = $apiInstance->getInboundGuidance($marketplace_id);
            
            print_r($result);
        } catch (Exception $e) {
            echo  '调用 FbaInboundApi->getInboundGuidance时出现异常:' , $e -> getMessage (), PHP_EOL ;
        }
    }
