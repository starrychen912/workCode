...
return [
    ...
    'token'                  => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => 'P1GluSYyzcRI2ZNdfWXekKU6gVDaFAE8',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
    ...
    'fastadmin'              => [
        ...
        //允许跨域的域名,多个以,分隔
        'cors_request_domain'   => 'localhost,127.0.0.1,shopify.ddtechinfo.com',
        //版本号
    ...
    //shopify配置
    'shopify'               => [
        'oauthSessionId'          => 'ddinfotech_oauth_session',
        'apiKey'                  => '3c6bac23c028babb12de1ca007c0f742',
        'apiSecretKey'            => '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',
        'scopes'                  => 'write_orders,read_orders,read_customers,write_products,read_products,read_product_listings,write_inventory',
        'hostName'                => 'interface.ddtechinfo.com',
    ],
];
