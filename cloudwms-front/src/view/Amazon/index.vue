<template>
  <el-container class="el-cotainer">
        <el-aside width="200px"  :class="{'el-menu--collapse':!collapse}" v-if="device == 'PC'">
          <shop-sidebarnav :Showvariable="collapse" :title="shop_info.name" :routeslist="routeslist"></shop-sidebarnav>
        </el-aside>
...
import { getShopInfo } from '../../api/shoplist';
    ...
    setup(props,context){
      ...
      const data = reactive({
        ...
        shop_info:"",
        routeslist:computed(()=>store.state.permission.shoprouters.Anazonshoplist)
      })
