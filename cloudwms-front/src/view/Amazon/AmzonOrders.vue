<template>
  <el-container>
      ...
      <el-main>
            ...
            <div class="prompt">亚马逊配送</div>
            <div class="order-type-list ">
                <div class="order-type-header-list flex justify-between align-center flex-wrap">
                    <div class="flex align-center">
                        <div class="type_content" :class="{'type_content-active':typeindex == 0}" @click="TypeClick(0)">等待中</div>
                        <div class="type_content" :class="{'type_content-active':typeindex == 1}" @click="TypeClick(1)">所有订单</div>
                        <div class="type_content" :class="{'type_content-active':typeindex == 2}" @click="TypeClick(2)">已取消</div>
                    </div>
                    <div class="select-Seller-order" @click="SellerFulilledProduct">
                      <a>查看卖家自配送订单</a>
                  ...
                  <div class="table-content-list">
                      <div class="table_content-l-header flex align-center justify-between flex-wrap">
                          <div class="table_content-l-h flex align-end flex-wrap">
                              ...
                              <div class="order-number">5个订单</div>
                              <span class="order-date">最近3天</span>
                          </div>
...
export default {
  ...
  setup(props,content){
    ...
    function SellerFulilledProduct(){
      router.push({path:"/Amazonshop/SellerFulfilledProduct"})
    }
    return {
      TypeClick,
      ...toRefs(data),
