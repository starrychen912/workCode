<template>
    <el-container>
        <el-header :class="{'el_header--bg':mode === 'mobile' }">
            <sidebar :LogoName="t('home.homename')"></sidebar>
        </el-header>
        <el-main>
                <el-row span="24" class="el-col---list">
                    <el-col :xs="24" :sm="24" :md="8" :lg="7" :xl="7" class="card-col-list el-card" @click="ToRouter('/index/OrderAll')">
                    ...
                    <el-col :xs="24" :sm="24" :md="8" :lg="7" :xl="7" class="card-col-list el-card" @click="ToRouter('/index/Products')">
                      ...
                      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="panel-footer">
                          ...
                          <div class="panel-context--list">
                              <div class="panel--list-table">
                                  ...
                                  <img src="https://cdn.shopify.com/s/files/1/0600/1390/4054/products/product-image-1429647494.jpg?v=1631772899">
...
<script>
import { defineComponent, reactive,ref,computed,onMounted,toRefs} from "vue"
...
export default {
    ...
    setup(props,context){
        ...
        const data = reactive({
            ...
            Topitem:{
                name:"",
                src: "/uploads/product/DA52BC20B2E750681215CC799A43CEE6.jpg",
                total: 0,
                total_sales: 0,
            },
