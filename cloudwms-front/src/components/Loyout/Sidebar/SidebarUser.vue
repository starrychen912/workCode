<template>
    <div class="flex align-center SidebarUser" aria-describedby="el-popper-4906">
        ...
        <div class="userinfo el-dropdown-selfdefine" data-v-8e021e66="" aria-haspopup="list" aria-controls="dropdown-menu-2706" role="button" tabindex="0">
            ...
            <!-- <div v-if="GetShopindex()">
                  <el-tooltip class="item" effect="dark" content="店铺管理" placement="bottom" >
                      <i class="el-icon-s-shop" @click="ShopManage"></i>
                  </el-tooltip>
              </div> -->
                   ...
                   <div class="userinfo-title">
                    ...
                    <div class="setting-notion">
                        ...
                        <div class="userinfo--seting">
                            ...
                            <div class="setting"  @click="Userouter('/Settings/Settings')">设置</div>
...
export default {
    ...
    setup(props,context){
        ...
        function Logout(){
            ...
            store.dispatch('permission/setRouter',null)
        }
