describe("Accessibility Tests", function() {
  ...
  it("Should have the slider role", function() {
    ...
    expect($sliderElementA.find('.min-slider-handle').attr('templates.admin.user.role')).toBe('slider');
    expect($sliderElementB.find('.min-slider-handle').attr('templates.admin.user.role')).toBe('slider');
    expect($sliderElementB.find('.max-slider-handle').attr('templates.admin.user.role')).toBe('slider');

    expect($sliderElementA.find('.tooltip-main').attr('templates.admin.user.role')).toBe('presentation');
    expect($sliderElementA.find('.tooltip-min').attr('templates.admin.user.role')).toBe('presentation');
    expect($sliderElementA.find('.tooltip-max').attr('templates.admin.user.role')).toBe('presentation');
  });
