<template>
  ...
  <div class="table--list flex flex-wrap">
    ...
    <div class="table_list">
      ...
      >
        ...
        <el-table-column prop="name" label="盘点单号"> </el-table-column>
        <el-table-column prop="address" label="盘点仓库"> </el-table-column>
  ...
  >
    <el-form ref="form" :model="ruleForm" :rules="rules">
      <el-form-item label="盘点单号：" label-width="18%" prop="name">
        <el-input style="max-width: 700px" v-model="ruleForm.name"></el-input>
      </el-form-item>
      <el-form-item label="盘点类型：" label-width="18%" prop="country">
        <el-select
      ...
      <el-form-item label="开始时间：" label-width="18%" prop="name">
        <el-date-picker v-model="value1" type="date" placeholder="选择日期">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="结束时间：" label-width="18%" prop="name">
        <el-date-picker v-model="value1" type="date" placeholder="选择日期">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="盘点仓库：" label-width="18%" prop="country">
        <el-select
          v-model="ruleForm.country"
          multiple
          filterable
