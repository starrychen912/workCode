<template>
  ...
  <!-- <el-container>
    <el-header>
      <sidebar LogoName="采购管理"></sidebar>
    </el-header>
    <el-main> -->
      <!-- 头部 -->
      <div class="bannerTop">
        <div class="leftB">
          <el-button  @click="addPur">添加采购</el-button>
        </div>
        <div class="searchRight">
          ...
          <div class="inventLocat">
            <el-select v-model="value2" style="width: 120px" size="mini">
              <el-option
      ...
      <div class="textLink">
        <div class="leftTips">
          <div class="Amazonproduct_application flex align-center flex-wrap">
           <ul class="application_list flex align-center flex-wrap">
              ...
              <el-divider direction="vertical"></el-divider>
              <li><router-link to="/purchasingManagement/mySettlement">我的结算</router-link></li>
              <el-divider direction="vertical"></el-divider>
              <p>我的收货</p>
            </ul>
          </div>
        ...
        <div class="rightTips">
          <div class="Amazonproduct_application flex align-center flex-wrap">
            <ul class="application_list flex align-center flex-wrap">
              <li><router-link to="javascript:#">30天内采购</router-link></li>
              <el-divider direction="vertical"></el-divider>
              <li><router-link to="javascript:#">全部采购</router-link></li>
            </ul>
          </div>
        </div>
      </div>
