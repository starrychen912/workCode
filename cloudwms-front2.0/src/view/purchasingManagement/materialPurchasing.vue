          ...
          <div class="leftTips">
            <div class="Amazonproduct_application flex align-center flex-wrap">
              <ul class="application_list flex align-center flex-wrap">
                <li><router-link to="/purchasingManagement/transactionPurchase">采购事务</router-link></li>
                <el-divider direction="vertical"></el-divider>
                <li><router-link to="/purchasingManagement/addPurchasing">添加采购</router-link></li>
                <el-divider direction="vertical"></el-divider>
      ...
      <div class="table_backCol">
        ...
        <div class="tableTips">
          <div class="tipsLeft">
            ...
            物料采购列表
            <router-link to="javascript:;">导出Excel</router-link>
          </div>
          <div class="tipsRight">
            <router-link to="javascript:;">全部</router-link>
            <router-link to="javascript:;">淘宝</router-link>
            <router-link to="javascript:;">阿里</router-link>
            <router-link to="javascript:;">亚马逊</router-link>
            <router-link to="javascript:;">京东</router-link>
            <router-link to="javascript:;">其他</router-link>
            <router-link to="javascript:;">生产</router-link>
            <router-link to="javascript:;">eBay</router-link>
            <router-link to="javascript:;">返回上级</router-link>
          </div>
        </div>
        <!-- 表格 -->
