<template>
  ...
  <!-- <el-container>
    <el-header>
      <sidebar LogoName="定制采购单管理"></sidebar>
    </el-header>
    <el-main> -->
      <!-- 头部 -->
      <div class="bannerTop">
          ...
          <div class="leftTips">
            <div class="Amazonproduct_application flex align-center flex-wrap">
              <ul class="application_list flex align-center flex-wrap">
                <li><router-link to="/purchasingManagement/addPurchasing">添加定制采购单</router-link></li>
              ...
              <el-divider direction="vertical"></el-divider>
                <p>定制采购单</p>
                <el-divider direction="vertical"></el-divider>
                <li><router-link to="/purchasingManagement/specialPurchasing">特殊采购</router-link></li>
                <el-divider direction="vertical"></el-divider>
      ...
      <div class="table_backCol">
        ...
        <div class="tableTips">
          <div class="tipsLeft">
            ...
            物料采购列表
            <router-link to="javascript:;">定制事物</router-link>
            <router-link to="javascript:;">发货列表</router-link>
          </div>
          <div class="tipsRight">
            <router-link to="javascript:;">全部</router-link>
            <router-link to="javascript:;">中奇</router-link>
            <router-link to="javascript:;">利君</router-link>
            <router-link to="javascript:;">通泽</router-link>
            <router-link to="javascript:;">可达</router-link>
            <router-link to="javascript:;">富田</router-link>
            <router-link to="javascript:;">新迪</router-link>
            <router-link to="javascript:;">脾威</router-link>
            <router-link to="javascript:;">厂家管理</router-link>
          </div>
        </div>
        <!-- 表格 -->
        <el-table :data="lis" style="width: 100%" :border="true">
          ...
          <el-table-column label="客户" prop="channel"> </el-table-column>
