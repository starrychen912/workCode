<template>
  ...
  <div class="product_integration--btn--list flex">
          ...
          <div class="table_backCol">
            ...
            <div class="itemList">
              <el-table :data="lis" style="width: 100%" :border="true">
                ...
                <el-table-column label="渠道名" prop="name" align="center">
                </el-table-column>

                <el-table-column label="网址" prop="invoiceNumber"
      ...
      <!-- 显示弹框 -->
      <el-dialog title="修改渠道" v-model="editVisi">
        <el-descriptions>
          <el-descriptions-item label="渠道名 :" class="des">
            <el-input placeholder="请输入内容" v-model="editList.name"> </el-input>
          </el-descriptions-item>
        </el-descriptions>
         <el-descriptions> 
             <el-descriptions-item label="网址 :" class="des">
            <el-input placeholder="请输入内容" v-model="editList.address"> </el-input>
