<template>
  ...
  <div class="product_integration--btn--list flex">
    <el-button type="primary" @click="dialogVisible = true">添加国家</el-button>
  ...
  <div class="table--list">
    ...
    >
      ...
      <el-table-column prop="name" label="中文名" min-width="100">
      </el-table-column>
      <el-table-column prop="englisthname" label="英文名" min-width="100">
      </el-table-column>
      <el-table-column prop="abbreviation" label="英文简称" min-width="100">
      </el-table-column>
      ...
      <el-table-column prop="content" label="备注" min-width="250">
      </el-table-column>
      <el-table-column prop="continent" label="洲" min-width="100">
      </el-table-column>
      <el-table-column
        label="操作"
        fixed="right"
  ...
  >
    <el-form ref="form" :model="ruleForm" :rules="rules">
      <el-form-item label="中文名：" label-width="18%" prop="Managementname">
        <el-input style="max-width: 700px" v-model="ruleForm.name"></el-input>
      </el-form-item>
      <el-form-item label="英文名：" label-width="18%" prop="Managementname">
        <el-input
          style="max-width: 700px"
          v-model="ruleForm.englisthname"
        ></el-input>
      </el-form-item>
      <el-form-item label="英文名称：" label-width="18%" prop="Managementname">
        <el-input
          style="max-width: 700px"
          v-model="ruleForm.abbreviation"
        ></el-input>
      </el-form-item>
      <el-form-item label="洲：" label-width="18%" prop="userlist">
        <el-select
