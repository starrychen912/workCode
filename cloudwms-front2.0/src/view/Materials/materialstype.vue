<template>
      ...
      <el-main> -->
         <div class="table--list flex flex-wrap">
           <div class="search--condition_list flex align-center">
                <el-button type="primary" @click="dialogVisible = true" icon="el-icon-plus">创建物料类型</el-button>
            </div>
            <div class="search--condition_list flex align-center">
  ...
  <el-dialog
        ...
        <el-form ref="form" :model="ruleForm" :rules="rules" >
            ...
            <el-form-item label="创建人：" label-width="18%" prop="country">
                <el-select
            ...
            <el-form-item label="创建时间：" label-width="18%" prop="country">
                <el-date-picker
                  v-model="value1"
                  type="date"
                  placeholder="选择日期">
