<template>
  ...
  <!-- <el-container>
    ...
    <el-main> -->
      ...
      <div class="bannerTop">
        <div class="leftB">
        <el-button  @click="proInfo()">商品资料</el-button>
          <el-button  @click="addBrand()">添加商品资料分类</el-button>
            <el-button @click="brandInfo()">商品资料品牌</el-button>
            <el-button>分类合并转移</el-button>
        </div>
      </div>
      <!-- 表格 -->
      <div class="table_backCol">
        ...
        <el-table :data="lis" style="width: 100%" :border="true">
          ...
          <el-table-column label="日文" prop="shop">
          </el-table-column>
          <el-table-column label="官网" prop="url" align="center" width="300px">
          </el-table-column>
              ...
              <template v-slot="scope">
                <div class="tableBtn">
                  ...
                  <el-button
                    ...
                    :disabled="scope.$index === lis.length - 1"
                    >下移</el-button
                  >
                  <el-button
                    type="success"
                    size="small"
                    @click="editVisible(scope.$index)"
                    >编辑</el-button
                  >
                  <el-button
                    type="danger"
  ...
  methods: {
    ...
    //商品资料
     proInfo() {
      ...
      brandInfo() {
        this.$router.push({
          path: "/ProductOperation/productInformation/index/index",
          query: {
            // ...item,
          },
        });
