...
const render = {
   ...
   */
     renderImageList: ({ text }) => {
      ...
      let Imageslist = avatarList.map(el =>{
          return getFileAccessHttpUrl(el)
      })
      return h(
        // http://183.238.147.82:8289/jeecg-boot/sys/common/s…2e9422485221c5f60e5ee46400x400_1657337742573.jpeg
        TableImg,{
          imgList:Imageslist,
          size:100
        }
